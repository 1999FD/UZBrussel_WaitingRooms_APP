...
<body>
    ...
    <iframe style="background-color: black; border: 0" id="iFrameObj" style="border: 0;" class="background" src="https://lg-player.cloudsignage.be/?mode=view-playlist&id=386"></iframe>
    <!-- <iframe style="border: 0 !important;" class="background"></iframe> -->
            ...
            methods: {
                showNewTicketPopup() {
                    ...
                    this.$nextTick(() => {
                        ...
                        }, 5000); // Popup stays visible for 4500ms before fading out
                    });
                },
                async fetchBackgroundTextAndOrientation(){
                    try{
                        ...
                        // backgroundText.textContent = jsonData.backgroundText; // Update background text
                        loadCSS(orientation)
                    } catch(error) {
                        ...
                        displayInfo.loketIDs.forEach(async loket => {
                            try{
                                ...
                                if(response.ok){
                                    ...
                                    // Also add the loketID as field
                                    newTicket.loketId = loket;
